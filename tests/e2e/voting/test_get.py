...
def test_vote_body_config_element_exists(page_voting: Page) -> None:
    """The vote body config element should exist with required data attributes."""
    config_element = page_voting.locator("#vote-body-config")
